...
const Header = () => {
  ...
  return (
    <>
      ...
      <header
        className={`h-auto full-width relative py-[15px] lg:py-[26px] ${isSticky ? "sticky-header" : ""
          }`}
      >
        ...
        <nav
          className={`fixed top-0 right-0 bg-white flex flex-col h-screen nav-shadow overflow-y-scroll nav-mobile transition-all duration-200 w-[380px] z-[100] ${menuOpen ? "" : "opacity-0 pointer-events-none"
            }  `}
        >
          ...
          <div className="p-[30px]">
            <ul className="font-chivo font-medium text-[16px] leading-[16px]">
              ...
              <li
                className={`group menu-mobile-item py-[13px] ${expanded && "expand"
                  }`}
